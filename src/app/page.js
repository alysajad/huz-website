              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex items-center gap-4 mt-2 pt-4 border-t border-outline-variant/20">
                  ...
                  <div className="flex gap-4">
                    <a href="https://www.instagram.com/huz_tour_and_travels_kmr?igsh=MTlpa3h2cXkyZHpkbw%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-on-surface-variant hover:text-pink-600 transition-colors" title="Instagram">
